      ...
      while True:
         ...
         while PawPrice == '':
            try:
               ...
               url = 'https://dexscreener.com/polygon/0x836051a89124d0ec92d4d614e23915dc00898566'
               r = await session.get(url)
               await r.html.arender(sleep=20, keep_page=True, timeout=60)
               soup = BeautifulSoup(r.html.raw_html, 'html.parser')
               PawPrice = soup.find_all('div', {'class' : 'css-1baulvz'})
