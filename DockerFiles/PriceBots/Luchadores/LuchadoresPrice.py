      ...
      while True:
         ...
         while PawPrice == '':
            try:
               ...
               url = 'https://charts.cometh.io/token/0x6749441fdc8650b5b5a854ed255c82ef361f1596'
               r = await session.get(url)
               await r.html.arender(sleep=35, keep_page=True, timeout=60)
               soup = BeautifulSoup(r.html.raw_html, 'html.parser')
               PawPrice = soup.find_all('div', {'class' : 'sc-bdVaJa KpMoH css-9on69b'})
